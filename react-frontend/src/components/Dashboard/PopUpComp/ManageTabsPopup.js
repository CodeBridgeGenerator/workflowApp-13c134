            ...
            <div className="mb-3">
                ...
                <div className="p-2">
                    <div className="flex items-center mb-3" style={{ alignItems: 'center' }}>
                        <img src={Data} alt="Data Icon" style={{ width: '1rem', height: '1rem', marginRight: '0.5rem' }} />
                ...
                <div className="p-2">
                    <div className="flex items-center mb-3" style={{ alignItems: 'center' }}>
                        <img src={Users} alt="Users Icon" style={{ width: '1rem', height: '1rem', marginRight: '0.5rem' }} />
                        <p className="font-semibold m-0" style={{ fontSize: '1rem' }}>
                            User management
                        </p>
                    </div>
