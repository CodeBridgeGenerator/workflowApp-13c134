...
const DashboardMessaging = (props) => {
    ...
    return (
        <ProjectSideBarLayout>
            <div className="p-2 md:p-4">
                ...
                <div className="surface-border border-round surface-card">
                    <div className="grid">
                        ...
                        <div className="col-12 md:col-4 mb-3">
                            <PinnedItems Pinned={'Pinned Items'} isEdit={isEdit} pinnedItems={pinnedItems} />
                        </div>

                        {/* Total Component */}
                        <div className="col-12 md:col-4">
                            <TotalComponent TotalComp={'Workforce Summary'} isEdit={isEdit} total={250} />
                        </div>
                    </div>
                </div>
            ...
            <BarChart total={"Total Users"} isEdit={isEdit} />
                ...
                <div>
                    <TeamMembers teamMembers={teamMembers} tabs={tabs} ActiveTab={ActiveTab} setActiveTab={setActiveTab} isEdit={isEdit} />
                </div>
            </div>
        </ProjectSideBarLayout>
    );
