...
describe('LoginPage', () => {
    ...
    test('displays validation error for invalid email', async () => {
        ...
        const testStatus = (await screen.findByText('Please Enter a valid Email address')) ? 'Passed' : 'Failed';
        const endTime = new Date();
        const result = {
            TestName: testName,
            TestStatus: testStatus,
    ...
    test('displays validation error for short password', async () => {
        ...
        const testStatus = (await screen.findByText('Please enter a valid password. Must be at least 6 characters')) ? 'Passed' : 'Failed';
        const endTime = new Date();
        const result = {
            TestName: testName,
            TestStatus: testStatus,
    ...
    test('shows forgot password dialog', async () => {
        ...
        const testStatus = screen.getByText('Forgot Password') ? 'Passed' : 'Failed';
        const endTime = new Date();
        const result = {
            TestName: testName,
            TestStatus: testStatus,
