...
const AreYouSureDialog = (props) => {
    const renderFooter = () => (
        <div className="flex justify-content-end">
            <Button label="Yes" className=" no-focus-effect" onClick={props.onYes} loading={props.loading} />
            <Button label="close" className="p-button-text no-focus-effect p-button-secondary" onClick={props.onHide} loading={props.loading} />
        </div>
    );
