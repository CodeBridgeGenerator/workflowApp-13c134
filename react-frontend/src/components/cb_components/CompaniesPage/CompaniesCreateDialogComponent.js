            ...
            <div className="grid p-fluid overflow-y-auto" style={{ maxWidth: '55vw' }} role="companies-create-dialog-component">
                ...
                <div className="col-12 md:col-6 field">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="newCompanyNumber" className="w-full mb-3 p-inputtext-sm" value={_entity?.newCompanyNumber} useGrouping={false} onChange={(e) => setValByKey('newCompanyNumber', e.value)} />
                    </span>
                    <small className="p-error">
