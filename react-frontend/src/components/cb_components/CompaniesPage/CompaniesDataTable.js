...
const CompaniesDataTable = ({
    ...
    return (
            ...
            {isLoadingPermissions ? (
                ...
                <>
                    ...
                    >
                        ...
                        <Column field="name" header="Name" body={pTemplate0} filter={selectedFilterFields.includes('name')} hidden={selectedHideFields?.includes('name')} sortable style={{ minWidth: '8rem' }} frozen />
                        <Column field="companyType" header="Company Type" body={pTemplate2} filter={selectedFilterFields.includes('companyType')} hidden={selectedHideFields?.includes('companyType')} sortable style={{ minWidth: '8rem' }} frozen />
        ...
        <Column header="Delete" body={deleteTemplate} /> */}
                        {permissions.update ? <Column header="Edit" body={editTemplate} /> : null}
                        {permissions.delete ? <Column header="Delete" body={deleteTemplate} /> : null}
                    </DataTable>
                    ...
                    <Dialog
                        ...
                        footer={
                            <div className="flex justify-content-center" style={{ padding: '1rem' }}>
                                ...
                                />
                                <Button label="Delete" onClick={confirmDelete} className="no-focus-effect" rounded style={{ width: '200px' }} />
                            </div>
                        }
                    >
                    ...
                    <DownloadCSV data={items} fileName="companies" triggerDownload={triggerDownload} setTriggerDownload={setTriggerDownload} selectedData={selectedItems} />
                </>
            ) : (
