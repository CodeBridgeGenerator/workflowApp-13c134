    ...
    return (
        <ProjectLayout>
            <div className="col-12 flex flex-column align-items-center">
                ...
                <CommentsSection recordId={urlParams.singleBranchesId} user={props.user} alert={props.alert} serviceName="branches" />
                {newRecentItem && <RecentService companyId={branchId} get={props.get} set={props.set} newRecentItem={newRecentItem} />}
