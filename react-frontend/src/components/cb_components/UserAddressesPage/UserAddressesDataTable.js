...
const UserAddressesDataTable = ({
    ...
    const pTemplate8 = (rowData, { rowIndex }) => <p>{String(rowData.isDefault)}</p>;
            ...
            {isLoadingPermissions ? (
                ...
                <>
                    ...
                    >
                        ...
                        <Column field="isDefault" header="is Def" body={pTemplate8} sortable style={{ minWidth: '8rem' }} />
                ...
                <div>You do not have permission to view User Addresses.</div>
            )}
        </>
    );
};
