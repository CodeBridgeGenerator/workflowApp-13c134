            ...
            <div className="grid p-fluid overflow-y-auto" style={{ maxWidth: '55vw' }} role="userChangePassword-create-dialog-component">
                ...
                <div className="col-12 md:col-6 field mt-5">
                    <span className="align-items-center">
                        ...
                        <InputNumber id="sendEmailCounter" className="w-full mb-3 p-inputtext-sm" value={_entity?.sendEmailCounter} useGrouping={false} onChange={(e) => setValByKey('sendEmailCounter', e.target.value)} />
                    </span>
                    <small className="p-error">
