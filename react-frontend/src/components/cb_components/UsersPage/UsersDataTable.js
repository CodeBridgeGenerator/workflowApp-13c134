...
const UsersDataTable = ({
    ...
    const confirmDelete = async () => {
        try {
            const promises = selectedItems.map((item) => client.service('users').remove(item._id));
        ...
        <>
            {isLoadingPermissions ? (
                ...
                <>
                    ...
                    <DownloadCSV data={items} fileName="users" triggerDownload={triggerDownload} setTriggerDownload={setTriggerDownload} selectedData={selectedItems} />
                </>
            ) : (
