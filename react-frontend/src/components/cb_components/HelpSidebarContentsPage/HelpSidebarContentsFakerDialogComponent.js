...
const HelpSidebarContentsFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        ...
        setLoading(true);
        const promises = fakeData.map((elem) => client.service('helpSidebarContents').create(elem));
...
export default connect(mapState, mapDispatch)(HelpSidebarContentsFakerDialogComponent);
