...
const CompanyPhonesDataTable = ({
    ...
    const confirmDelete = async () => {
        try {
            const promises = selectedItems.map((item) => client.service('companyPhones').remove(item._id));
        ...
        <>
            {isLoadingPermissions ? (
                ...
                <>
                    ...
                    <DownloadCSV data={items} fileName="companyPhones" triggerDownload={triggerDownload} setTriggerDownload={setTriggerDownload} selectedData={selectedItems} />
                </>
            ) : (
