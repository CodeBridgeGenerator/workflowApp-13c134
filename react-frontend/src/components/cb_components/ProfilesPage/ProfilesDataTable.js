...
const ProfilesDataTable = ({
    ...
    const confirmDelete = async () => {
        try {
            const promises = selectedItems.map((item) => client.service('profiles').remove(item._id));
            ...
            {isLoadingPermissions ? (
                ...
                <>
                    ...
                    >
                        ...
                        <Column field="email" header="email" body={pTemplate2} filter={selectedFilterFields.includes('email')} hidden={selectedHideFields?.includes('email')} style={{ minWidth: '8rem' }} />
                    ...
                    <DownloadCSV data={items} fileName="profiles" triggerDownload={triggerDownload} setTriggerDownload={setTriggerDownload} selectedData={selectedItems} />
                </>
            ) : (
