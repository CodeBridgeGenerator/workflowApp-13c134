...
const PositionsDataTable = ({
    ...
    const confirmDelete = async () => {
        try {
            const promises = selectedItems.map((item) => client.service('positions').remove(item._id));
        ...
        <>
            {isLoadingPermissions ? (
                ...
                <>
                    ...
                    <DownloadCSV data={items} fileName="positions" triggerDownload={triggerDownload} setTriggerDownload={setTriggerDownload} selectedData={selectedItems} />
                </>
            ) : (
