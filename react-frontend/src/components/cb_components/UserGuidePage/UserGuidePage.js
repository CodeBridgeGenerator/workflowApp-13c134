            ...
            <div className="grid">
                ...
                <div className="col-6 flex justify-content-end">
                    <>
                        ...
                        ></SplitButton>
                        <Button label="add" style={{ height: '30px', marginRight: '10px' }} rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="userGuide-add-button" />
                    </>
                </div>
            </div>
