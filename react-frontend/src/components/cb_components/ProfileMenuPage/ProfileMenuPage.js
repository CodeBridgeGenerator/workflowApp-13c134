...
const ProfileMenuPage = (props) => {
    ...
    useEffect(() => {
        ...
        const _fields = simplifiedSchema.data.map((field, i) => i > 15 && field.field).filter(Boolean);
            ...
            <div className="grid">
                ...
                <div className="col-6 flex justify-content-end">
                    <>
                        ...
                        ></SplitButton>
                        <Button label="add" style={{ height: '30px' }} rounded loading={loading} icon="pi pi-plus" onClick={handleAddClick} role="profileMenu-add-button" />
                    </>
                </div>
            </div>
